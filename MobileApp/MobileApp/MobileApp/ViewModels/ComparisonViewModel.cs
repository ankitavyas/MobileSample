...
namespace MobileApp.ViewModels
{
    ...
    public class ComparisonViewModel : BaseDataObject
    {
        ...
        public ComparisonViewModel(ComparisonSelection comparisonSelection, DifficultyLevelEnum difficultyLevelEnum)
        {
            _difficultyLevelEnum = difficultyLevelEnum;
            _ComparisionOperation = comparisonSelection.ComparisionOperation;
